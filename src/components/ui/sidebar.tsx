 ...
 *
 * Com 48px o trilho ficava mais estreito que o próprio símbolo da marca, e os
 * ícones encostavam nas bordas — parecia defeito de renderização, não escolha.
 * 64px dá respiro ao botão de 40px sem roubar área útil da tela.
 */
