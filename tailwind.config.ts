  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
         ...
         * mesma em tudo, e misturar duas grotescas daria duas fontes discutindo:
         * parecidas o bastante para não contrastar, diferentes o bastante para
         * incomodar.
         *
         * A família é Roboto, a do print de referência.
         *
